...
The data is skewed to the left as the median is higher than the mean (4.3 > 4.17)
...
Jitter adds some sort of random variation to each point, not sure why anyone would ever want that tbh 
...
The gradient is small but positive which means that professors with a higher beauty rating tend to have a higher satisfaction score
...
The intercept predicts the satisfaction score when the professor is given the lowest beauty rating possible
